<template>
  <footer :class="$style.footer">
    ...
    <p>Designed by A.Inajarin and built by M.Aitmiloud, data provided by <a target="_blank" href="https://www.themoviedb.org/" rel="noopener">TMDb</a>.</p>

    <ul class="nolist">
      <li>
        <a
          href="https://github.com/Mohamedaitmiloud"
          target="_blank"
